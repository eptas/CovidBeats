...
lena-esther.ptasczynski@charite.de

Patrick Blättermann  
Institute of Sound and Vibration Engineering, Hochschule Düsseldorf  
patrick.blaettermann@hs-duesseldorf.de
...
```
    ...
    ##  [1] tidyselect_1.2.0    fastmap_1.1.1       digest_0.6.33       rpart_4.1.21        estimability_1.5.1  timechange_0.2.0    lifecycle_1.0.4     cluster_2.1.4       ellipsis_0.3.2     
    ## [10] magrittr_2.0.3      compiler_4.3.2      rlang_1.1.4         Hmisc_5.1-1         sass_0.4.7          tools_4.3.2         utf8_1.2.4          yaml_2.3.7          data.table_1.16.2  
    ## [19] htmlwidgets_1.6.4   foreign_0.8-85      withr_3.0.2         numDeriv_2016.8-1.1 nnet_7.3-19         grid_4.3.2          fansi_1.0.6         colorspace_2.1-0    emmeans_1.10.6     
    ## [28] scales_1.2.1        insight_0.19.6      cli_3.6.3           rmarkdown_2.24      generics_0.1.3      rstudioapi_0.15.0   tzdb_0.4.0          cachem_1.0.8        minqa_1.2.5        
    ## [37] splines_4.3.2       base64enc_0.1-3     vctrs_0.6.5         boot_1.3-28.1       jsonlite_1.8.9      hms_1.1.3           Formula_1.2-5       htmlTable_2.4.2     crosstalk_1.2.1    
    ## [46] jquerylib_0.1.4     glue_1.8.0          nloptr_2.0.3        cowplot_1.1.2       stringi_1.7.12      gtable_0.3.4        munsell_0.5.0       pillar_1.9.0        htmltools_0.5.7    
    ## [55] R6_2.5.1            lpSolve_5.6.23      evaluate_0.21       lattice_0.21-9      highr_0.10          backports_1.5.0     bslib_0.5.1         Rcpp_1.0.11         coda_0.19-4.1      
    ## [64] gridExtra_2.3       nlme_3.1-163        checkmate_2.3.2     xfun_0.40           zoo_1.8-12          pkgconfig_2.0.3
