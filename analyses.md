...
![](analyses_files/figure-gfm/unnamed-chunk-18-1.png)<!-- -->

``` r
qqnorm(resid(model_period_dance_lmtest))
```

![](analyses_files/figure-gfm/unnamed-chunk-18-2.png)<!-- -->

``` r
hist(resid(model_period_dance_lmtest))
```

![](analyses_files/figure-gfm/unnamed-chunk-18-3.png)<!-- -->
...
|:----------------------------------------------------------|:------------------|:--------------------------|:-----------------------|:---------------------------|:---------------------------|:------------------------------|:---------------------------|
| Stringency -\> SPS SUM Score -\> Dance                    | Danceability_mean | SPS_SUM_mean              | 0.004\* (p = 0.038)    | -0.141\*\*\* (p = \<0.001) | -0.137\*\*\* (p = \<0.001) | -0.148\* (p = 0.0119)         | -0.028\* (p = 0.0271)      |
| Stringency -\> SPS Social Integration -\> Dance           | Danceability_mean | SPS_SI_mean               | 0.002 (p = 0.212)      | -0.138\*\*\* (p = \<0.001) | -0.136\*\*\* (p = \<0.001) | -0.115. (p = 0.0517)          | -0.018 (p = 0.1565)        |
| Stringency -\> SPS Reassurance of worth score -\> Dance   | Danceability_mean | SPS_ROW_mean              | 0.003. (p = 0.098)     | -0.140\*\*\* (p = \<0.001) | -0.137\*\*\* (p = \<0.001) | -0.100. (p = 0.0918)          | -0.032\*\* (p = 0.0090)    |
| Stringency -\> SPS Attachment -\> Dance                   | Danceability_mean | SPS_A_mean                | 0.006\* (p = 0.028)    | -0.141\*\*\* (p = \<0.001) | -0.135\*\*\* (p = \<0.001) | -0.232\*\*\* (p = \<0.001)    | -0.027\* (p = 0.0276)      |
| Stringency -\> SPS Sense of reliable alliance -\> Dance   | Danceability_mean | SPS_SORA_mean             | 0.004. (p = 0.052)     | -0.141\*\*\* (p = \<0.001) | -0.137\*\*\* (p = \<0.001) | -0.139\* (p = 0.0186)         | -0.026\* (p = 0.0353)      |
| Stringency -\> SPS Guidance -\> Dance                     | Danceability_mean | SPS_G_mean                | 0.000 (p = 0.692)      | -0.138\*\*\* (p = \<0.001) | -0.138\*\*\* (p = \<0.001) | -0.044 (p = 0.4662)           | -0.011 (p = 0.3726)        |
| Stringency -\> Scale SLON SUM -\> Dance                   | Danceability_mean | Scale_SLON_SUM_mean       | 0.000 (p = 0.766)      | -0.131\*\*\* (p = \<0.001) | -0.131\*\*\* (p = \<0.001) | 0.019 (p = 0.7497)            | 0.013 (p = 0.2564)         |
| Stringency -\> Scale PSS10 UCLA SUM_mean -\> Dance        | Danceability_mean | Scale_PSS10_UCLA_SUM_mean | 0.000 (p = 0.878)      | -0.132\*\*\* (p = \<0.001) | -0.132\*\*\* (p = \<0.001) | 0.028 (p = 0.6436)            | 0.004 (p = 0.7728)         |
| Stringency -\> SPS SUM Score -\> Valence                  | Valence_mean      | SPS_SUM_mean              | -0.003 (p = 0.128)     | 0.122\*\*\* (p = \<0.001)  | 0.119\*\*\* (p = \<0.001)  | -0.148\* (p = 0.0119)         | 0.021 (p = 0.1236)         |
| Stringency -\> SPS Social Integration -\> Valence         | Valence_mean      | SPS_SI_mean               | -0.001 (p = 0.436)     | 0.117\*\*\* (p = \<0.001)  | 0.116\*\*\* (p = \<0.001)  | -0.115. (p = 0.0517)          | 0.010 (p = 0.4690)         |
| Stringency -\> SPS Reassurance of worth score -\> Valence | Valence_mean      | SPS_ROW_mean              | -0.002 (p = 0.202)     | 0.121\*\*\* (p = \<0.001)  | 0.119\*\*\* (p = \<0.001)  | -0.100. (p = 0.0918)          | 0.020 (p = 0.1358)         |
| Stringency -\> SPS Attachment -\> Valence                 | Valence_mean      | SPS_A_mean                | -0.005 (p = 0.114)     | 0.120\*\*\* (p = \<0.001)  | 0.115\*\*\* (p = \<0.001)  | -0.232\*\*\* (p = \<0.001)    | 0.021 (p = 0.1238)         |
| Stringency -\> SPS Sense of reliable alliance -\> Valence | Valence_mean      | SPS_SORA_mean             | -0.002 (p = 0.418)     | 0.118\*\*\* (p = \<0.001)  | 0.116\*\*\* (p = \<0.001)  | -0.139\* (p = 0.0186)         | 0.010 (p = 0.4641)         |
| Stringency -\> SPS Guidance -\> Valence                   | Valence_mean      | SPS_G_mean                | -0.001 (p = 0.508)     | 0.121\*\*\* (p = \<0.001)  | 0.119\*\*\* (p = \<0.001)  | -0.044 (p = 0.4662)           | 0.029\* (p = 0.0319)       |
| Stringency -\> SPS SUM Score -\> Energy                   | Energy_mean       | SPS_SUM_mean              | 0.001 (p = 0.698)      | -0.008 (p = 0.730)         | -0.007 (p = 0.752)         | -0.148\* (p = 0.0119)         | -0.005 (p = 0.6668)        |
| Stringency -\> SPS Social Integration -\> Energy          | Energy_mean       | SPS_SI_mean               | 0.001 (p = 0.514)      | -0.009 (p = 0.686)         | -0.008 (p = 0.714)         | -0.115. (p = 0.0517)          | -0.007 (p = 0.4833)        |
| Stringency -\> SPS Reassurance of worth score -\> Energy  | Energy_mean       | SPS_ROW_mean              | 0.000 (p = 0.718)      | -0.008 (p = 0.736)         | -0.007 (p = 0.754)         | -0.100. (p = 0.0918)          | -0.004 (p = 0.6713)        |
| Stringency -\> SPS Attachment -\> Energy                  | Energy_mean       | SPS_A_mean                | -0.001 (p = 0.766)     | -0.008 (p = 0.718)         | -0.009 (p = 0.684)         | -0.232\*\*\* (p = \<0.001)    | 0.002 (p = 0.8480)         |
| Stringency -\> SPS Sense of reliable alliance -\> Energy  | Energy_mean       | SPS_SORA_mean             | 0.000 (p = 0.700)      | -0.009 (p = 0.676)         | -0.009 (p = 0.694)         | -0.139\* (p = 0.0186)         | -0.004 (p = 0.6703)        |
| Stringency -\> SPS Guidance -\> Energy                    | Energy_mean       | SPS_G_mean                | 0.000 (p = 0.822)      | -0.008 (p = 0.740)         | -0.007 (p = 0.750)         | -0.044 (p = 0.4662)           | -0.005 (p = 0.6018)        |
...
| Stringency -\> SPS SUM Score -\> Dance                    | Danceability_mean | SPS_SUM_mean              | Total effect           |   -0.137 | \[-0.178, -0.094\] |   0.000 | \*\*\*       |
...
| Stringency -\> SPS Social Integration -\> Dance           | Danceability_mean | SPS_SI_mean               | Total effect           |   -0.136 | \[-0.178, -0.094\] |   0.000 | \*\*\*       |
...
| Stringency -\> SPS Reassurance of worth score -\> Dance   | Danceability_mean | SPS_ROW_mean              | Total effect           |   -0.137 | \[-0.179, -0.095\] |   0.000 | \*\*\*       |
...
| Stringency -\> SPS Attachment -\> Dance                   | Danceability_mean | SPS_A_mean                | Total effect           |   -0.135 | \[-0.177, -0.093\] |   0.000 | \*\*\*       |
...
| Stringency -\> SPS Sense of reliable alliance -\> Dance   | Danceability_mean | SPS_SORA_mean             | Total effect           |   -0.137 | \[-0.179, -0.095\] |   0.000 | \*\*\*       |
...
| Stringency -\> SPS Guidance -\> Dance                     | Danceability_mean | SPS_G_mean                | Total effect           |   -0.138 | \[-0.179, -0.095\] |   0.000 | \*\*\*       |
...
| Stringency -\> Scale SLON SUM -\> Dance                   | Danceability_mean | Scale_SLON_SUM_mean       | Total effect           |   -0.131 | \[-0.171, -0.091\] |   0.000 | \*\*\*       |
...
| Stringency -\> Scale PSS10 UCLA SUM_mean -\> Dance        | Danceability_mean | Scale_PSS10_UCLA_SUM_mean | Total effect           |   -0.132 | \[-0.172, -0.092\] |   0.000 | \*\*\*       |
...
| Stringency -\> SPS SUM Score -\> Valence                  | Valence_mean      | SPS_SUM_mean              | Total effect           |    0.119 | \[0.073, 0.164\]   |   0.000 | \*\*\*       |
...
| Stringency -\> SPS Social Integration -\> Valence         | Valence_mean      | SPS_SI_mean               | Total effect           |    0.116 | \[0.070, 0.161\]   |   0.000 | \*\*\*       |
...
| Stringency -\> SPS Reassurance of worth score -\> Valence | Valence_mean      | SPS_ROW_mean              | Total effect           |    0.119 | \[0.074, 0.164\]   |   0.000 | \*\*\*       |
...
| Stringency -\> SPS Attachment -\> Valence                 | Valence_mean      | SPS_A_mean                | Total effect           |    0.115 | \[0.068, 0.159\]   |   0.000 | \*\*\*       |
...
| Stringency -\> SPS Sense of reliable alliance -\> Valence | Valence_mean      | SPS_SORA_mean             | Total effect           |    0.116 | \[0.071, 0.161\]   |   0.000 | \*\*\*       |
...
| Stringency -\> SPS Guidance -\> Valence                   | Valence_mean      | SPS_G_mean                | Total effect           |    0.120 | \[0.074, 0.165\]   |   0.000 | \*\*\*       |
...
| Stringency -\> SPS SUM Score -\> Energy                   | Energy_mean       | SPS_SUM_mean              | Total effect           |   -0.007 | \[-0.043, 0.028\]  |   0.752 |              |
...
| Stringency -\> SPS Social Integration -\> Energy          | Energy_mean       | SPS_SI_mean               | Total effect           |   -0.008 | \[-0.043, 0.027\]  |   0.714 |              |
...
| Stringency -\> SPS Reassurance of worth score -\> Energy  | Energy_mean       | SPS_ROW_mean              | Total effect           |   -0.007 | \[-0.043, 0.028\]  |   0.754 |              |
...
| Stringency -\> SPS Attachment -\> Energy                  | Energy_mean       | SPS_A_mean                | Total effect           |   -0.009 | \[-0.044, 0.026\]  |   0.684 |              |
...
| Stringency -\> SPS Sense of reliable alliance -\> Energy  | Energy_mean       | SPS_SORA_mean             | Total effect           |   -0.009 | \[-0.044, 0.026\]  |   0.694 |              |
...
| Stringency -\> SPS Guidance -\> Energy                    | Energy_mean       | SPS_G_mean                | Total effect           |   -0.007 | \[-0.043, 0.028\]  |   0.750 |              |
...
```
    ...
    ##  [1] performance_0.10.8 lubridate_1.9.2    forcats_1.0.0      stringr_1.5.0      readr_2.1.4        tidyr_1.3.0        ggplot2_3.4.3      tidyverse_2.0.0    DT_0.34.0         
    ## [10] knitr_1.43         purrr_1.0.1        mediation_4.5.1    sandwich_3.1-1     mvtnorm_1.3-2      MASS_7.3-60        tibble_3.2.1       dplyr_1.1.2        lmerTest_3.1-3    
    ## [19] lme4_1.1-34        Matrix_1.6-1.1    
    ## 
    ## loaded via a namespace (and not attached):
    ##  [1] gtable_0.3.4        xfun_0.40           htmlwidgets_1.6.4   insight_0.19.6      lattice_0.21-9      tzdb_0.4.0          numDeriv_2016.8-1.1 vctrs_0.6.5         tools_4.3.2        
    ...
    ## [19] munsell_0.5.0       htmltools_0.5.7     yaml_2.3.7          htmlTable_2.4.2     Formula_1.2-5       pillar_1.9.0        nloptr_2.0.3        Hmisc_5.1-1         rpart_4.1.21       
    ## [28] boot_1.3-28.1       nlme_3.1-163        tidyselect_1.2.0    digest_0.6.33       stringi_1.7.12      splines_4.3.2       cowplot_1.1.2       fastmap_1.1.1       grid_4.3.2         
    ## [37] colorspace_2.1-0    cli_3.6.3           magrittr_2.0.3      base64enc_0.1-3     utf8_1.2.4          withr_3.0.2         foreign_0.8-85      scales_1.2.1        backports_1.5.0    
    ## [46] timechange_0.2.0    estimability_1.5.1  rmarkdown_2.24      emmeans_1.10.6      nnet_7.3-19         gridExtra_2.3       hms_1.1.3           zoo_1.8-12          coda_0.19-4.1      
    ## [55] evaluate_0.21       lpSolve_5.6.23      rlang_1.1.4         Rcpp_1.0.11         glue_1.8.0          rstudioapi_0.15.0   minqa_1.2.5         R6_2.5.1
