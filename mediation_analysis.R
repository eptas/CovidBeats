...
#Spread filtered data to show distribution of answered questionnaires per day, which results in 11 European countries for further analysis
nature_select_filter_spread<-nature_select_filter%>%spread('Country','Count_nature_data')


###############################################################################
# Filter data for analysis (pre-processing)
###############################################################################
...
##Check regression assumptions (visually)
